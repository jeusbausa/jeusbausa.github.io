    ...
    return (
        <div id="about" ref={ref} className="flex xss:flex-col-reverse xl:max-w-3xl lg:max-w-full lg:flex-row xs:flex-col-reverse xl:min-h-screen items-center section">
            <div className="lg:max-w-2xl xs:max-w-4xl xs:mt-12 xl:flex-1 lg:flex-wrap">
                <Reveal cascade>
                    <div className="font-poppins font-bold text-5xl mb-6">What I do?</div>
                    <div>
                        <p className="font-poppins font-light text-pBg xl:max-w-md mb-6 leading-6">
                            I'm a professional software engineer with three years of experience in coding, creating user interfaces, testing, and fixing issues. I really enjoy
                            learning about new technologies and I'm good at motivating myself to do well.
                        </p>
                    </div>
                ...
                <div className="md:flex md:flex-row xss:grid xss:grid-cols-3 md:space-x-6 mb-12">
                    <Slide direction="up" cascade>
                        ...
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            ...
                            >
                                <g transform="matrix(1.25305,0,0,1.25305,-16.3076,4.57191)">
                                    <circle cx="64" cy="47.5" r="9.3" style={{ fill: "#9dedf8" }} />
                                    <path
                                        ...
                                        style={{ fill: "#9dedf8", fillRule: "nonzero" }}
                                    />
                                </g>
                            </svg>
                            <span>React.js</span>
                        ...
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 32 32" style={{ fill: "#9dedf8" }}>
                    ...
                    <Slide direction="up" delay={2500} fraction={1} cascade>
                        <div className="font-poppins font-light text-xs">
                            <div onClick={() => onShowTechStack(true)} className="mr-1 cursor-pointer inline-flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30" fill="#9dedf8">
