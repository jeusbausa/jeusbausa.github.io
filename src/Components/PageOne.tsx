...
const PageOne: React.FC<{ onShowTechStack: (value: boolean) => void; ref: Ref<HTMLDivElement>; }> = React.forwardRef(({ onShowTechStack }, ref: Ref<HTMLDivElement>) => {
    return (
        <div id="about" ref={ref} className="flex xss:flex-col-reverse xl:max-w-3xl lg:max-w-full lg:flex-row xs:flex-col-reverse xl:min-h-screen items-center section">
            <div className="lg:max-w-2xl xs:max-w-4xl xs:mt-12 xl:flex-1 lg:flex-wrap">
                <Reveal cascade>
                    <div className="font-poppins font-bold text-5xl mb-6">About Me</div>
                    <div>
                        <p className="font-poppins font-light text-pBg xl:max-w-md mb-6 leading-6">
                            A natural problem solver who approaches challenges with creativity, persistence, and self-motivation, I am confident that I can contribute and share my skills and knowledge and my unwavering determination to elevate the technology industry to new heights.
                        </p>
                    </div>
                ...
                <div className="md:flex md:flex-row xss:grid xss:grid-cols-3 md:space-x-6 mb-12">
                    <Slide direction="up" cascade>
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg style={{ fill: "#9dedf8" }} width="40" height="40" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg
                                style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2, fill: "#9dedf8" }}
                                version="1.1"
                                viewBox="0 0 256 256"
                                width="40"
                                height="40"
                        ...
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg fill="none" height="40" viewBox="0 0 15 15" width="40" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg style={{ fill: "#9dedf8", fillRule: "evenodd" }} width="40" height="40" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><title>file_type_prisma</title><path d="M25.21,24.21,12.739,27.928a.525.525,0,0,1-.667-.606L16.528,5.811a.43.43,0,0,1,.809-.094l8.249,17.661A.6.6,0,0,1,25.21,24.21Zm2.139-.878L17.8,2.883h0A1.531,1.531,0,0,0,16.491,2a1.513,1.513,0,0,0-1.4.729L4.736,19.648a1.592,1.592,0,0,0,.018,1.7l5.064,7.909a1.628,1.628,0,0,0,1.83.678l14.7-4.383a1.6,1.6,0,0,0,1-2.218Z" /></svg>
                            <span>Prisma</span>
                        </div>
                        <div className="flex flex-col items-center transform duration-200 hover:scale-110">
                            <svg width="40" height="40" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
                ...
                <Fade delay={2500}>
                    <Slide direction="up" delay={2500} fraction={1} cascade>
                        <div className="font-poppins font-light text-xs">
                            <div onClick={() => onShowTechStack(true)} className="mr-1 cursor-pointer inline-flex items-center">
                                See my full tech stack
                                <svg style={{ paddingLeft: "0.3rem" }} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30" fill="#9dedf8">
            ...
            <Fade delay={500} className="xss:mb-24" direction="up" cascade>
                <Avatar />
            </Fade>
        </div>
    );
