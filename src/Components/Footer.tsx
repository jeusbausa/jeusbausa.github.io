...
const Footer: React.FC = (): JSX.Element => {
    return (
        <Reveal>
            <div className="flex justify-center xl:max-w-3xl xss:max-w-full xss:flex-col section text-white">
                <p className="font-poppins inline flex-row font-light text-xs text-center text-pBg max-w-4xl">
                    ...
                    <svg
                        ...
                        height="20"
                        width="20"
                        viewBox="0 0 340.856 340.856"
                        enableBackground="new 0 0 340.856 340.856"
                        xmlSpace="preserve"
                    >
                        <path
                            fill="#ff7876"
                            d="M171.9,241.571l0.011-0.004c-23.918-25.017-5.88-66.318,28.274-66.416
...
l-0.022,0.009l111.643,116.045c15.673,16.292,41.747,16.292,57.421,0l10.259-10.664L171.9,241.571z"
                        ...
                        <path
                            fill="#ffdb77"
                            d="M278.979,175.15c-21.748-0.062-39.397,17.549-39.397,39.282c0-21.733-17.649-39.344-39.397-39.282
...
l-0.011-0.004C331.171,216.549,313.133,175.248,278.979,175.15z"
                        ...
                        <path
                            fill="#414042"
                            d="M88.81,59.922c-0.007,0-0.015,0-0.022,0c-30.742,0.089-56.803,24.462-58.673,55.247
    ...
    c4.142-0.012,7.49-3.379,7.479-7.521C96.298,63.266,92.942,59.922,88.81,59.922z"
                        ...
                        <path
                            fill="#414042"
                            d="M313.555,183.087c18.996-19.747,28.786-42.274,27.117-69.737
    ...
    c0-17.376,13.988-31.782,31.874-31.782C304.763,182.725,321.996,213.158,301.574,236.668z"
                    ...
                    &nbsp; | Jeus Bausa &copy; {new Date().getUTCFullYear()}
                </p>
            </div>
        </Reveal>
    );
